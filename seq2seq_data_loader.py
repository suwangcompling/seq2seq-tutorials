...
class Seq2SeqDataLoader(DataLoader):
    """Loading formatted seq2seq data."""
...
class Seq2SeqDataLoaderTransformer(DataLoader):
    """Loading formatted seq2seq data."""
    ...
    def load(self):
        indexer = IndexerTransformer() # [CHANGE] no more special token.
        print "... loading training data."
        trainPairs,trainLens = self._load_pairs(indexer,
                                                self.dataDict['train_source'],
                                                self.dataDict['train_target'])
...
if __name__ == "__main__":
    ...
    loader = Seq2SeqDataLoader(args.data_dir)
    print "Loading data ..."
